...
is
   ...
   subtype Genode_Int8_T is Cbe.Signed_Char;
   subtype Genode_Int8_T_Array is Cbe.Signed_Char_Array;
   subtype Genode_Uint8_T is Cbe.Unsigned_Char;
   subtype Genode_Uint8_T_Array is Cbe.Unsigned_Char_Array;
   subtype Genode_Int16_T is Cbe.Short;
   subtype Genode_Int16_T_Array is Cbe.Short_Array;
   subtype Genode_Uint16_T is Cbe.Unsigned_Short;
   subtype Genode_Uint16_T_Array is Cbe.Unsigned_Short_Array;
   subtype Genode_Int32_T is Cbe.Int;
   subtype Genode_Int32_T_Array is Cbe.Int_Array;
   subtype Genode_Uint32_T is Cbe.Unsigned_Int;
   subtype Genode_Uint32_T_Array is Cbe.Unsigned_Int_Array;
   subtype Genode_Int64_T is Cbe.Long_Long;
   subtype Genode_Int64_T_Array is Cbe.Long_Long_Array;
   subtype Genode_Uint64_T is Cbe.Unsigned_Long_Long;
   subtype Genode_Uint64_T_Array is Cbe.Unsigned_Long_Long_Array;
private
