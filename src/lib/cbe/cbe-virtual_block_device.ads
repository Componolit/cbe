...
package Cbe.Virtual_Block_Device with
   Spark_Mode
is
   pragma Pure;
   ...
   --  Tree_Height
   --
   function Tree_Height (Obj : Object_Type) return Tree_Level_Type;
   ...
   --  Get_Tree_Helper
   --
   function Get_Tree_Helper (Obj : Object_Type) return Tree_Helper.Object_Type;
