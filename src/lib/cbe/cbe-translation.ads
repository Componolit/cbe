...
is
   ...
   function Initialized_Object (Helpr   : Tree_Helper.Object_Type;
                                Free_Tr : Boolean) return Object_Type;
   ...
   function Index (Obj   : Object_Type;
                   ...
                   Level : Tree_Level_Type) return Tree_Child_Index_Type;

   --
   --  Return whether the pool can accept a new request
   --
   function Acceptable (Obj : Object_Type) return Boolean;
   ...
   --
   function Get_Virtual_Block_Address (Obj : Object_Type) return Block_Number_Type;
   --  with
   --      Pre => Primitive.Block_Number (Prim) = Obj.Data_PBA;
...
private
   ...
   --  Data_Invalid_Object
   --
   function Data_Initialized_Object return Data_Type;

   --
   --  Data_Available
   --
   function Data_Available (Data  : Data_Type;
                            Level : Tree_Level_Type) return Boolean;

   --
   --  Data_Set_Available
   --
   procedure Data_Set_Available (Data  : in out Data_Type;
                                 Level :        Tree_Level_Type);
