...
package body Cbe.Tree_Helper with
   Spark_Mode
is
   ...
   --  Initialized_Object
   --
   function Initialized_Object (Degr : Tree_Degree_Type;
                                Hght : Tree_Level_Type;
                                Lfs  : Tree_Number_Of_Leafs_Type) return Object_Type
   is
      Degr_Log_2 : constant Tree_Degree_Log_2_Type := Tree_Degree_Log_2_Type (Log_2 (Unsigned_32 (Degr)));
   begin
      return (Degree  => Degr, Height => Hght, Leafs => Lfs, Degree_Log_2 => Degr_Log_2,
          Degree_Mask => Tree_Degree_Mask_Type (Shift_Left (Unsigned_32 (1), Natural (Degr_Log_2))) - 1);
