...
--      pragma Pure;
   ...
   function Superblock_Dirty (Obj : Object_Type) return Boolean;
   function Is_Securing_Superblock (Obj : Object_Type) return Boolean;
   function Is_Sealing_Generation (Obj : Object_Type) return Boolean;
   ...
   --
   function Peek_Completed_Request (Obj : Object_Type) return Request.Object_Type;
...
private
   ...
   function Request_Primitive_Invalid return Request_Primitive_Type is
      (Req => Request.Invalid_Object, Prim => Primitive.Invalid_Object, Tag => Tag_Invalid, In_Progress => False);
