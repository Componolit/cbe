...
is
   ...
   --  Initialized_Object
   --
   function Initialized_Object (Key : Key_Type) return Object_Type;
   ...
   procedure Submit_Decryption_Primitive (Obj         : in out Object_Type;
                                          ...
                                          Cipher_Data :        Cipher_Data_Type) with
   ...
   procedure Submit_Encryption_Primitive (Obj        : in out Object_Type;
                                          Prim       :        Primitive.Object_Type;
                                          Plain_Data :        Plain_Data_Type) with
      Pre => (Primitive_Acceptable (Obj) and Primitive.Valid (Prim));
   ...
   --  Copy_Decrypted_Data
   --
   procedure Copy_Decrypted_Data (Obj        :     Object_Type;
                                  Prim       :     Primitive.Object_Type;
   ...
   --  Copy_Encrypted_Data
   --
   procedure Copy_Encrypted_Data (Obj         :     Object_Type;
                                  Prim        :     Primitive.Object_Type;
