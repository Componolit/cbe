...
is
   ...
   --  Curr_Primitive
   --
   function Curr_Primitive (Obj : Object_Type) return Primitive.Object_Type with
   ...
   --
   procedure Initialize_Object (Obj : out Object_Type) with
   ...
   --
   function Number_Of_Primitives (Req : Request.Object_Type) return Number_Of_Primitives_Type with
   ...
   --
   function Peek_Generated_Primitive (Obj : Splitter.Object_Type) return Primitive.Object_Type;
