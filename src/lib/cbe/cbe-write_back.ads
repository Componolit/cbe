...
is
   ...
   type New_Pbas_Type is array (Tree_Level_Index_Type'Range) of Physical_Block_Address_Type;
--      type Old_PBAs_Type is array (Tree_Level_Index_Type'Range) of Type_1_Node_Info_Type;
