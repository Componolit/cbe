...
is
   ...
   function Peek_Generated_Data_Index (Obj  : Object_Type;
                                       Prim : Primitive.Object_Type) return Cache_Index_Type with
   ...
   procedure Drop_Generated_Primitive (Obj  : in out Object_Type;
                                       Prim :        Primitive.Object_Type) with
      Pre => Primitive.Valid (Prim);
...
private
   ...
   is
      ...
      --  Unused_Object
      --
      function Unused_Object return Cache_Item_Type;
   ...
   is
      ...
      --  Pending_Object
      --
      function Pending_Object (Pba : Physical_Block_Address_Type) return Job_Item_Type;

      --
      --  Unused_Object
      --
      function Unused_Object return Job_Item_Type;
      ...
      procedure Set_Success (Obj : in out Job_Item_Type;
                             Suc :        Boolean);
